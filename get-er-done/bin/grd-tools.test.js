...
const TOOLS_PATH = path.join(__dirname, 'grd-tools.js');

// Helper to run grd-tools command
function runGrdTools(args, cwd = process.cwd()) {
  try {
...
function createTempProject() {
  const tmpDir = fs.mkdtempSync(path.join(require('os').tmpdir(), 'grd-test-'));
...
describe('history-digest command', () => {
  ...
  test('empty phases directory returns valid schema', () => {
    const result = runGrdTools('history-digest', tmpDir);
...
describe('phases list command', () => {
  ...
  test('empty phases directory returns empty array', () => {
    const result = runGrdTools('phases list', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('--type plans lists only PLAN.md files', () => {
    ...
    const result = runGrdTools('phases list --type plans', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('--type summaries lists only SUMMARY.md files', () => {
    ...
    const result = runGrdTools('phases list --type summaries', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('--phase filters to specific phase directory', () => {
    ...
    const result = runGrdTools('phases list --type plans --phase 01', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runGrdTools('roadmap get-phase 1', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runGrdTools('roadmap get-phase 5', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runGrdTools('roadmap get-phase 2.1', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('phase next-decimal command', () => {
  ...
  test('returns X.1 when no decimal phases exist', () => {
    ...
    const result = runGrdTools('phase next-decimal 06', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('handles single-digit phase input', () => {
    ...
    const result = runGrdTools('phase next-decimal 6', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('phase-plan-index command', () => {
  ...
  test('empty phase directory returns empty plans array', () => {
    ...
    const result = runGrdTools('phase-plan-index 03', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
  ...
  test('phase not found returns error', () => {
    const result = runGrdTools('phase-plan-index 99', tmpDir);
    assert.ok(result.success, `Command should succeed: ${result.error}`);
...
describe('state-snapshot command', () => {
  ...
  test('missing STATE.md returns error', () => {
    const result = runGrdTools('state-snapshot', tmpDir);
    assert.ok(result.success, `Command should succeed: ${result.error}`);
...
describe('summary-extract command', () => {
  ...
  test('missing file returns error', () => {
    const result = runGrdTools('summary-extract .planning/phases/01-test/01-01-SUMMARY.md', tmpDir);
    assert.ok(result.success, `Command should succeed: ${result.error}`);
...
`
    ...
    const result = runGrdTools('summary-extract .planning/phases/01-foundation/01-01-SUMMARY.md', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runGrdTools('summary-extract .planning/phases/01-foundation/01-01-SUMMARY.md --fields one_liner,key_files', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('init commands with --include flag', () => {
  ...
  test('init execute-phase includes state and config content', () => {
    ...
    const result = runGrdTools('init execute-phase 03 --include state,config', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init execute-phase without --include omits content', () => {
    ...
    const result = runGrdTools('init execute-phase 03', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init plan-phase includes multiple file contents', () => {
    ...
    const result = runGrdTools('init plan-phase 03 --include state,roadmap,requirements,context,research', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init plan-phase includes verification and uat content', () => {
    ...
    const result = runGrdTools('init plan-phase 03 --include verification,uat', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('init progress includes state, roadmap, project, config', () => {
    ...
    const result = runGrdTools('init progress --include state,roadmap,project,config', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('partial includes work correctly', () => {
    ...
    const result = runGrdTools('init execute-phase 03 --include state', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('roadmap analyze command', () => {
  ...
  test('missing ROADMAP.md returns error', () => {
    const result = runGrdTools('roadmap analyze', tmpDir);
    assert.ok(result.success, `Command should succeed: ${result.error}`);
...
`
    ...
    const result = runGrdTools('phase add User Dashboard', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('handles empty roadmap', () => {
    ...
    const result = runGrdTools('phase add Initial Setup', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runGrdTools('phase insert 1 Fix Critical Bug', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runGrdTools('phase insert 1 Another Fix', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('rejects missing phase', () => {
    ...
    const result = runGrdTools('phase insert 99 Fix Something', tmpDir);
...
`
    ...
    // Remove phase 2
    const result = runGrdTools('phase remove 2', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('rejects removal of phase with summaries unless --force', () => {
    ...
    const result = runGrdTools('phase remove 1', tmpDir);
    ...
    const forceResult = runGrdTools('phase remove 1 --force', tmpDir);
  ...
  test('removes decimal phase and renumbers siblings', () => {
    ...
    const result = runGrdTools('phase remove 6.2', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('updates STATE.md phase count', () => {
    ...
    runGrdTools('phase remove 2', tmpDir);
...
`
    ...
    const result = runGrdTools('phase complete 1', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('milestone complete command', () => {
  ...
  test('archives roadmap, requirements, creates MILESTONES.md', () => {
    ...
    const result = runGrdTools('milestone complete v1.0 --name MVP Foundation', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('appends to existing MILESTONES.md', () => {
    ...
    const result = runGrdTools('milestone complete v1.0 --name Beta', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('validate consistency command', () => {
  ...
  test('passes for consistent project', () => {
    ...
    const result = runGrdTools('validate consistency', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('progress command', () => {
  ...
  test('renders JSON progress', () => {
    ...
    const result = runGrdTools('progress json', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('renders bar format', () => {
    ...
    const result = runGrdTools('progress bar --raw', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('renders table format', () => {
    ...
    const result = runGrdTools('progress table --raw', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('todo complete command', () => {
  ...
  test('moves todo from pending to completed', () => {
    ...
    const result = runGrdTools('todo complete add-dark-mode.md', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('fails for nonexistent todo', () => {
    const result = runGrdTools('todo complete nonexistent.md', tmpDir);
...
describe('scaffold command', () => {
  ...
  test('scaffolds context file', () => {
    ...
    const result = runGrdTools('scaffold context --phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('scaffolds UAT file', () => {
    ...
    const result = runGrdTools('scaffold uat --phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('scaffolds verification file', () => {
    ...
    const result = runGrdTools('scaffold verification --phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('scaffolds phase directory', () => {
    const result = runGrdTools('scaffold phase-dir --phase 5 --name User Dashboard', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
