...
- `/grd:list-phase-assumptions 2` â€” check assumptions
...
**Also available:**
- `/grd:discuss-phase 2` â€” gather context first
- `/grd:research-phase 2` â€” investigate unknowns
- Review roadmap
...
**Also available:**
- `/grd:discuss-phase 3` â€” gather context first
- `/grd:research-phase 3` â€” investigate unknowns
