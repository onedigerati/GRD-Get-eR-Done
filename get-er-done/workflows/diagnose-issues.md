...
```bash
node ~/.claude/get-er-done/bin/grd-tools.js commit "docs({phase}): add root causes from diagnosis" --files ".planning/phases/XX-name/{phase}-UAT.md"
```
</step>
