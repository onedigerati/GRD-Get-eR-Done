...
See ~/.claude/get-er-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/get-er-done/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/get-er-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/get-er-done/templates/discovery.md
...
Use ~/.claude/get-er-done/templates/discovery.md.
