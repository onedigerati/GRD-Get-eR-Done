...
Auto mode requires an idea document via @ reference (e.g., `/grd:new-project --auto @prd.md`). If no document provided, error:

```
Error: --auto requires an idea document via @ reference.

Usage: /grd:new-project --auto @your-idea.md
...
```bash
INIT=$(node ~/.claude/get-er-done/bin/grd-tools.js init new-project)
```

Parse JSON for: `researcher_model`, `synthesizer_model`, `roadmapper_model`, `commit_docs`, `project_exists`, `has_codebase_map`, `planning_exists`, `has_existing_code`, `has_package_file`, `is_brownfield`, `needs_codebase_map`, `has_git`.

**If `project_exists` is true:** Error â€” project already initialized. Use `/grd:progress`.
...
- options:
  - "Map codebase first" â€” Run /grd:map-codebase to understand existing architecture (Recommended)
...
```bash
mkdir -p .planning
node ~/.claude/get-er-done/bin/grd-tools.js commit "docs: initialize project" --files .planning/PROJECT.md
```
...
```bash
node ~/.claude/get-er-done/bin/grd-tools.js commit "chore: add project config" --files .planning/config.json
```
...
```
TeamCreate(name="grd-project-research")

TaskCreate(subject="Research tech stack", description="Investigate standard stack for [domain]. Write .planning/research/STACK.md.", activeForm="Researching tech stack")
TaskCreate(subject="Research features", description="Investigate table stakes and differentiating features for [domain]. Write .planning/research/FEATURES.md.", activeForm="Researching features")
TaskCreate(subject="Research architecture", description="Investigate system architecture patterns for [domain]. Write .planning/research/ARCHITECTURE.md.", activeForm="Researching architecture")
...
```
Task(team_name="grd-project-research", prompt="First, read ~/.claude/agents/grd-project-researcher.md for your role and instructions.

<team_context>
You are a member of team 'grd-project-research'. Use TaskUpdate to mark your task completed when done. Use SendMessage to DM the orchestrator if you hit issues.
</team_context>
...
Use template: ~/.claude/get-er-done/templates/research-project/STACK.md
</output>
...
Use template: ~/.claude/get-er-done/templates/research-project/FEATURES.md
</output>
...
Use template: ~/.claude/get-er-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: ~/.claude/get-er-done/templates/research-project/PITFALLS.md
</output>
...
```bash
node ~/.claude/get-er-done/bin/grd-tools.js commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node ~/.claude/get-er-done/bin/grd-tools.js commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
...
```
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
 GRD â–º PROJECT INITIALIZED âœ“
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
...
/grd:discuss-phase 1 â€” gather context and clarify approach
...
**Also available:**
- /grd:plan-phase 1 â€” skip discussion, plan directly
