...
<required_reading>
@~/.claude/get-er-done/references/continuation-format.md
</required_reading>
...
ðŸ“‹ [N] pending todos â€” /grd:check-todos to review
...
- **Plan phase** â†’ Show command for user to run after clearing:
  ...
  **Also available:**
  - `/grd:discuss-phase [N]` â€” gather context first
  - `/grd:research-phase [N]` â€” investigate unknowns
