...
- `/grd:check-todos` â†’ show all
- `/grd:check-todos api` â†’ filter to area:api only
</step>
...
- options:
  - "Work on it now" â€” move to done, start working
  - "Create a phase" â€” /grd:add-phase with this scope
  - "Brainstorm approach" â€” think through before deciding
  - "Put it back" â€” return to list
</step>
...
node ~/.claude/get-er-done/bin/grd-tools.js commit "docs: start work on todo - [title]" --files .planning/todos/done/[filename] .planning/STATE.md
```
