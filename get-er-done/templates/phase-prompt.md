...
<!-- For checkpoint task examples and patterns, see @~/.claude/get-er-done/references/checkpoints.md -->
...
See `~/.claude/get-er-done/references/tdd.md` for TDD plan structure.
...
See `~/.claude/get-er-done/templates/user-setup.md` for full schema and examples
...
See `~/.claude/get-er-done/workflows/verify-phase.md` for verification logic.
