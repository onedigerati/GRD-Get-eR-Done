...
â”‚   â””â”€â”€ grd/           # GRD-specific commands
â”œâ”€â”€ get-er-done/     # Skill resources
...
**New Template:**
- Implementation: `get-er-done/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `get-er-done/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/get-er-done/workflows/{name}.md`

**New Reference Document:**
- Implementation: `get-er-done/references/{name}.md`
