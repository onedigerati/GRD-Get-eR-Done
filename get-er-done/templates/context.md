...
- `grd-phase-researcher` â€” Reads decisions to focus research (e.g., "card layout" â†’ research card component patterns)
- `grd-planner` â€” Reads decisions to create specific tasks (e.g., "infinite scroll" â†’ task includes virtualization)
