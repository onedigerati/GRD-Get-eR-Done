...
Instead, please report them via email to: **security@grd.build** (or DM @glittercowboy on Discord/Twitter if email bounces)
...
Security issues in the GRD codebase that could:
